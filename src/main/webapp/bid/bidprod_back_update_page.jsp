...
<!-- 					</div> -->
					...
					<div class="row mb-3 align-items-center">
						...
						<div class="col-4">
							...
							<input class="bid-input form-control" type="text" name="bidStart" value="${param.bidStart}"
							 id="date1">
						</div>
					...
					<div class="row mb-3 align-items-center">
						...
						<div class="col-4">
							<input class="bid-input form-control" type="text" name="bidEnd" value="${param.bidEnd}"
								id="date2">
						</div>
