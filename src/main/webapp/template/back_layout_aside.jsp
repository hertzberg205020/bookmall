...
<aside class="aside">
  ...
  <nav class="nav">
    <ul class="menu">
      <li>
        <img class="img2" src="../images/member.png" height="20px" width="20px">
      ...
      <li>
        <img class="img2" src="${pageContext.request.contextPath}/images/pricing.png" height="20px" width="20px">
